...
1. Configure a Project and a job template with [webhook property enabled](https://docs.ansible.com/automation-controller/4.4/html/userguide/webhooks.html#id2) in the Controller pointing to the playbook in charge of CD. [You can find an example here](https://github.com/redhat-cop/infra.controller_configuration/blob/devel/tests/playbooks/cd_gitlab_webhook_trigger.yml).
