...
- ci: add qemu tests for Fedora 43, drop Fedora 41 (#248)
- ci: bump actions/upload-artifact from 5 to 6 (#249)
- refactor: handle INJECT_FACTS_AS_VARS=false by using ansible_facts instead (#250)
...
- fix: cannot use community-general version 12 - no py27 and py36 support (#245)

### Other Changes

- ci: bump actions/checkout from 4 to 5 (#231)
- ci: rollout several recent changes to CI testing (#233)
- ci: support openSUSE Leap in qemu/kvm test matrix (#234)
- ci: use the new epel feature to enable EPEL for testing farm (#235)
- ci: use tox-lsr 3.12.0 for osbuild_config.yml feature (#237)
- ci: use JSON format for __bootc_validation (#238)
- ci: bump actions/github-script from 7 to 8 (#239)
- ci: bump actions/upload-artifact from 4 to 5 (#240)
- ci: use versioned upload-artifact instead of master; bump codeql-action to v4; bump upload-artifact to v5 (#241)
- ci: bump tox-lsr to 3.13.0 (#242)
- ci: bump tox-lsr to 3.14.0 - this moves standard-inventory-qcow2 to tox-lsr (#244)
